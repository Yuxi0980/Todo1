...
exports.RegisterPage = {
    ...
    genderMaleOption: screenplay_protractor_1.Target.the('gender male option').located(protractor_1.by.css('input[value="M"]')),
    genderFemaleOption: screenplay_protractor_1.Target.the('gender female option').located(protractor_1.by.css('input[value="F"]')),
